...
|------|----------------------------------|
| 多边主义 / 单边主义 | Multilateralism vs unilateralism — normative frames in MFA/media statements |
| 霸权主义 | Hegemonism — critical label in public diplomatic rhetoric |
| 周边外交 | Neighborhood diplomacy — regional relationship management vocabulary |
| 全球治理 | Global governance — forums, rules, and institutional participation frame |
| 制裁 | Sanctions — when present in text, gloss as public dispute instrument, not proof of intent beyond the wording |
